...
const tools = [
  {
    ...
    micro: "Extract deep meaning and verified insights from any academic paper.",
  ...
  },
  {
    name: "KARION",
    path: "/karion",
    label: "Citation Intel",
    micro: "Verify metadata and format academic citations with perfect precision.",
  ...
  },
  {
    ...
    micro: "Transform complex research concepts into structured visual diagrams.",
  ...
  },
  {
    ...
    path: "/deoza",
    label: "Invention Lab",
    micro: "Generate novel hypotheses and uncover untapped research territories.",
  ...
  },
  {
    ...
    micro: "Automate publication-ready LaTeX formatting for any research paper.",
  ...
  },
  {
    ...
    micro: "Refine AI outputs with natural, high-authenticity academic humanization.",
...
const steps = [
  { n: "01", title: "Ingest", body: "Upload raw papers or data. ALAMIX and KARION extract core intelligence and verify sources." },
  { n: "02", title: "Synthesize", body: "Visualise concepts with SAYON and innovate with DEOZA to expand your paper's horizons." },
  { n: "03", title: "Format", body: "Perfect your output with LEXORA's LaTeX engine and SENTIC's high-fidelity humanization." },
];

const stats = [
  { label: "6 Core Engines", sub: "Fully integrated research workflow" },
  { label: "Hyper-Precision", sub: "Academic-grade accuracy across all tools" },
  { label: "Seamless Sync", sub: "Intelligence shared across the entire suite" },
];
